(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 67881, 20783, 91918, 47163, 75254, e => {
    "use strict";
    let r, t;
    var o = e.i(43476),
        n = e.i(71645);
    ...
    e.s(["composeRefs", () => s, "useComposedRefs", () => i], 20783);
    var a = n.forwardRef((e, r) => {
        let {
            children: t,
            ...l
        } = e, s = n.Children.toArray(t), i = s.find(u);
        if (i) {
            let e = i.props.children,
                t = s.map(r => r !== i ? r : n.Children.count(e) > 1 ? n.Children.only(null) : n.isValidElement(e) ? e.props.children : null);
            return (0, o.jsx)(d, { ...l,
                ref: r,
    ...
    var d = n.forwardRef((e, r) => {
        ...
        if (n.isValidElement(t)) {
            var l;
            let e, i, a = (l = t, (i = (e = Object.getOwnPropertyDescriptor(l.props, "ref") ? .get) && "isReactWarning" in e && e.isReactWarning) ? l.ref : (i = (e = Object.getOwnPropertyDescriptor(l, "ref") ? .get) && "isReactWarning" in e && e.isReactWarning) ? l.props.ref : l.props.ref || l.ref);
            return n.cloneElement(t, { ... function(e, r) {
                    let t = { ...r
                    };
                    for (let o in r) {
                        let n = e[o],
    ...
    e.s(["Slot", () => a], 91918);
    let b = e => "boolean" == typeof e ? `${e}` : 0 === e ? "0" : e,
        f = (e, r) => {
            if (0 === e.length) return r.classGroupId;
            let t = e[0],
                o = r.nextPart.get(t),
                n = o ? f(e.slice(1), o) : void 0;
            if (n) return n;
        ...
        m = (e, r, t, o) => {
            e.forEach(e => {
                if ("string" == typeof e) {
                    ("" === e ? r : h(r, e)).classGroupId = t;
                    return
                }
                "function" == typeof e ? v(e) ? m(e(o), r, t, o) : r.validators.push({
                    validator: e,
                    classGroupId: t
        ...
        v = e => e.isThemeGetter,
        y = (e, r) => r ? e.map(([e, t]) => [e, t.map(e => "string" == typeof e ? r + e : "object" == typeof e ? Object.fromEntries(Object.entries(e).map(([e, t]) => [r + e, t])) : e)]) : e,
        x = e => {
    ...
    function k() {
        let e, r, t = 0,
            o = "";
        for (; t < arguments.length;)(e = arguments[t++]) && (r = z(e)) && (o && (o += " "), o += r);
        return o
    }
    let z = e => {
            let r;
            ...
            let t = "";
            for (let o = 0; o < e.length; o++) e[o] && (r = z(e[o])) && (t && (t += " "), t += r);
            return t
        },
        j = e => {
            let r = r => r[e] || [];
        ...
        H = e => O.test(e) && !S.test(e),
        J = () => !1,
        Q = e => P.test(e),
        X = e => $.test(e),
        Y = function(e, ...r) {
            let t, o, n, l = function(i) {
                let a;
                return o = (t = {
                    cache: (e => {
                        if (e < 1) return {
                    ...
                    ...(e => {
                        let r = (e => {
                                ...
                                return y(Object.entries(e.classGroups), t).forEach(([e, t]) => {
                                    m(t, o, e, r)
                                }), o
                            })(e),
                            {
                        ...
                        return {
                            getClassGroupId: e => {
                                let t = e.split("-");
                                return "" === t[0] && 1 !== t.length && t.shift(), f(t, r) || (e => {
                                    if (g.test(e)) {
                                        let r = g.exec(e)[1],
                ...
                }).cache.get, n = t.cache.set, l = s, s(i)
            };
            ...
            return function() {
                return l(k.apply(null, arguments))
            }
        }(() => {
            let e = j("colors"),
                r = j("spacing"),
                ...
                D = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"],
            ...
            return {
                ...
                theme: {
                    ...
                    gradientColorStopPositions: [T, G],
                    inset: E(),
                    margin: E(),
                    opacity: Q(),
                    padding: O(),
                ...
                classGroups: {
                    ...
                    leading: [{
                        leading: ["none", "tight", "snug", "normal", "relaxed", "loose", A, V]
                    }],
                    "list-image": [{
                        "list-image": ["none", V]
                    }],
                    ...
                    "text-decoration-thickness": [{
                        decoration: ["auto", "from-font", A, G]
                    }],
                    "underline-offset": [{
                        "underline-offset": ["auto", A, V]
                    }],
    ...
    e.s(["cn", () => ee], 47163);
    let er = (r = "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive", t = {
        variants: {
            variant: {
        ...
        var o;
        if ((null == t ? void 0 : t.variants) == null) return p(r, null == e ? void 0 : e.class, null == e ? void 0 : e.className);
        let {
            variants: n,
            defaultVariants: l
        } = t, s = Object.keys(n).map(r => {
            let t = null == e ? void 0 : e[r],
                o = null == l ? void 0 : l[r];
            if (null === t) return null;
            let s = b(t) || b(o);
            return n[r][s]
        }), i = e && Object.entries(e).reduce((e, r) => {
            let [t, o] = r;
            return void 0 === o || (e[t] = o), e
        }, {});
        return p(r, s, null == t || null == (o = t.compoundVariants) ? void 0 : o.reduce((e, r) => {
            let {
                class: t,
                className: o,
                ...n
    ...
    e.s(["Button", () => et], 67881);
    let eo = (...e) => e.filter((e, r, t) => !!e && "" !== e.trim() && t.indexOf(e) === r).join(" ").trim();
    var en = {
    ...
    let el = (0, n.forwardRef)(({
            ...
            className: eo("lucide", l),
            ...a
        }, [...i.map(([e, r]) => (0, n.createElement)(e, r)), ...Array.isArray(s) ? s : [s]])),
        es = (e, r) => {
            let t = (0, n.forwardRef)(({
                className: t,
                ...o
            }, l) => (0, n.createElement)(el, {
                ref: l,
                iconNode: r,
                className: eo(`lucide-${e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase()}`, t),
                ...o
            }));
            return t.displayName = `${e}`, t
        };
    e.s(["default", () => es], 75254)
}]);