(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 12718, (e, t, r) => {
    ...
    var S = O.prototype = new v;
    S.constructor = O, E(S, R.prototype), S.isPureReactComponent = !0;
    var P = Array.isArray;
    ...
    function N(e, t, r) {
        ...
        return ! function e(t, r, n, a, i) {
            ...
            if (d) return i = i(t), d = "" === a ? "." + C(t, 0) : a, P(i) ? (n = "", null != d && (n = d.replace(A, "$&/") + "/"), e(i, r, n, "", function(e) {
                return e
            })) : null != i && (x(i) && (c = i, s = n + (null == i.key || t && t.key === i.key ? "" : ("" + i.key).replace(A, "$&/") + "/") + d, i = D(c.type, s, c.props)), r.push(i)), 1;
            d = 0;
            var p = "" === a ? "." : a + ":";
            if (P(t))
                for (var _ = 0; _ < t.length; _++) f = p + C(a = t[_], _), d += e(a, r, n, f, i);
            else if ("function" == typeof(_ = null === (l = t) || "object" != typeof l ? null : "function" == typeof(l = b && l[b] || l["@@iterator"]) ? l : null))
                for (t = _.call(t), _ = 0; !(a = t.next()).done;) f = p + C(a = a.value, _++), d += e(a, r, n, f, i);
            else if ("object" === f) {
    ...
    }, r.Component = R, r.Fragment = a, r.Profiler = c, r.PureComponent = O, r.StrictMode = i, r.Suspense = d, r.ViewTransition = m, r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = T, r.__COMPILER_RUNTIME = {
        __proto__: null,
        c: function(e) {
            return T.H.useMemoCache(e)
        }
    }, r.addTransitionType = H, r.cache = function(e) {
        return function() {
    ...
    }, r.isValidElement = x, r.lazy = function(e) {
        return {
            $$typeof: y,
            _payload: {
                _status: -1,
    ...
    function s(e, t) {
        throw c(e, t ? ? = i ? .getStore() ? .isAction ? a.RedirectType.push : a.RedirectType.replace, u.RedirectStatusCode.TemporaryRedirect)
    }
...
${t}`))
  ...
  - Rerun the production build with \`next build --debug-prerender\` to generate better stack traces.`))
    ...
    Object.defineProperty(r, "__esModule", {
        ...
        get: function() {
            return function e(t) {
                if ((0, a.isNextRouterError)(t) || (0, u.isBailoutToCSRError)(t) || (0, c.isDynamicServerError)(t) || (0, i.isDynamicPostpone)(t) || (0, o.isPostpone)(t) || (0, n.isHangingPromiseRejectionError)(t) || (0, i.isPrerenderInterruptedError)(t)) throw t;
                t instanceof Error && "cause" in t && e(t.cause)
            }
        }
    });
